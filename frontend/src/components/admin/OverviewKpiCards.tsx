  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        >
          <Card className="h-full hover:border-clinical-400 hover:shadow-md transition-all cursor-pointer">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  <CardTitle className="text-sm font-semibold text-slate-900 group-hover:text-clinical-700 transition-colors">
                ...
                <div className="p-2 rounded-lg bg-emerald-50 text-emerald-600 group-hover:bg-clinical-50 group-hover:text-clinical-600 transition-colors">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-1">
          <Link
            to="/admin/verifications?status=pending"
            className="group flex items-start gap-3 p-4 rounded-xl border border-slate-200 hover:border-emerald-300 hover:bg-emerald-50/30 transition-all"
          >
            <div className="p-2 rounded-lg bg-slate-100 text-slate-700 group-hover:bg-emerald-100 group-hover:text-emerald-700 transition-colors">
              <UserCheck className="h-5 w-5" />
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                <h4 className="text-sm font-semibold text-slate-900 group-hover:text-emerald-700">Dentist Verifications</h4>
                <ArrowRight className="h-4 w-4 text-slate-400 group-hover:translate-x-0.5 transition-transform" />
              </div>
              <p className="text-xs text-slate-500 mt-1 line-clamp-2">
                Inspect practitioner license credentials, evaluate submitted documents, and approve or reject clinical access.
              </p>
            </div>
          </Link>
