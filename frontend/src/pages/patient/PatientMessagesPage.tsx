/**
 * OraVisionAI — Patient Direct Messaging Console (Phase 27)
 *
 * Dedicated two-pane messaging layout for patient-dentist communication.
 * Connects conversation thread listing, chronological message stream,
 * text composer, and conversation initiation.
 */
        ...
        >
          <div className="flex-1 overflow-hidden">
            <MessageThread
              ...
              onReactivate={() =>
                reactivateCurrentConversation(
                  selectedConversation?.dentist_id || '',
                  'patient',
                )
              }
